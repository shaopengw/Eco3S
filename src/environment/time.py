class Time:
    ...
    def get_elapsed_time_steps(self):
        ...
        :return: 已经过去的时间步长
        """
        elapsed_years = self.current_year - self.start_year
        elapsed_quarters = self.current_quarter - 1
        return elapsed_years * 4 + elapsed_quarters
